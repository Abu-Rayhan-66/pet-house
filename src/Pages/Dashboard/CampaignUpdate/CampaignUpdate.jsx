...
const CampaignUpdate = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (res.data.success) {
            ...
            const menuRes = await axiosPublic.patch(`/campaigns/${CampaignData._id}`, userInfo)
            console.log(menuRes.data)
            if (menuRes.data.modifiedCount > 0) {
                Swal.fire("Campaign Updated successfully");
            }
    ...
    return (
        <div >
         ...
         md:p-10 bg-white bg-opacity-50  hover:shadow-2xl  rounded-md' >
                    <h2 className='text-3xl font-bold text-blue-600'>Update Your Campaign</h2>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className=' w-40 h-80 relative'>
                        ...
                        <input defaultValue={CampaignData.name} className='pl-2 rounded-md py-2 w-[300px] bg-black md:w-[400px] text-lg'
                        ...
                        <input defaultValue={CampaignData.amount} className='pl-2 rounded-md py-2 w-[300px] bg-black md:w-[400px] text-lg'
                        ...
                        <input defaultValue={CampaignData.date} className='pl-2 rounded-md py-2 w-[300px] bg-black md:w-[400px] text-lg'
                        ...
                        <input defaultValue={CampaignData.description} className='pl-2 rounded-md py-2 w-[300px] bg-black md:w-[400px] text-lg'
                        ...
                        <textarea defaultValue={CampaignData.longDescription} {...register("longDescription", { required: true })} type="text" placeholder='Long Description' className='pl-2 rounded-md py-2 w-[300px] bg-black md:w-[400px] text-lg' cols="30" rows="2"></textarea>
